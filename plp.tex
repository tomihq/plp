...
Un tipo está habitado si existe una función de ejemplo que use ese tipo o más formalmente dicho, si existe un término M tal que el juicio $\vdash M:\tau$ es derivable \\
...
Decimos que la reducción está determinada (hay determinismo) cuando cada término que \textbf{NO} está en forma normal tiene una única forma de reducir.
