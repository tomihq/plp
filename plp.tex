...
En las reglas de tipado tenemos contexto, en las reglas de semántica, no. Hay una \textbf{pequeña excepción}, y es, cuando necesitamos de antemano conocer como dato el tipo de salida de una función a la hora de aplicar la regla de semántica. 
\[\begin{minipage}[b]{1\textwidth}
...
\subsection*{Valores}
Los valores de la extensión de cálculo lambda particular son los términos reducidos de mi extensión que representan mi tipo en forma irreducible. 
...
\subsection*{Cantidad de Reglas de Tipado}
Agregamos, al menos una por cada término. 
