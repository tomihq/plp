...
\textbf{Importante}: ¿Qué pasa si hacemos \text{raiz(Nil)}? Explota. En estos casos particulares que no está definido, no haríamos una regla de tipado para ese caso, y, si tenemos que hacer una macro, en el caso nil devolveríamos un $\bot$ del tipo de salida del case. 
