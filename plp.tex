...
El algoritmo de inferencia de tipos se basa en manipualr tipos \textbf{parcialmente conocidos}. \\
...
\end{itemize}
Ej.: $\neg (((P \implies (Q \land R)) \land P) \implies Q)$ en forma Clausal es $(\neg P \lor Q) \land (\neg P \lor R) \land P \land \neg Q$ \\
...
\begin{itemize}
    ...
    \item Ej.: $\exists X . P(x)$ se skolemiza a $P(c)$ donde c es una nueva constante que se agrega al lenguaje de primer orden. Estas funciones y constantes como parámetros.
\end{itemize}
...
\subsubsection*{Refutación en Lógica de Primer Orden}
