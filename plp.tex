...
\subsection{Semántica Operacional small-step}
\[\begin{minipage}[b]{0.7\textwidth}
    \includegraphics[width=\linewidth]{assets/evaluacion_expresiones_booleanas.png}
\end{minipage}\]
\[\begin{minipage}[b]{0.8\textwidth}
    \includegraphics[width=\linewidth]{assets/evaluacion_funciones.png}
\end{minipage}\]
